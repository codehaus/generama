...
classDefinition![TokenKeepingAST modifiers]
	:	"class" IDENT
...
interfaceDefinition![TokenKeepingAST modifiers]
	:	"interface" IDENT
...
variableDefinitions[TokenKeepingAST mods, TokenKeepingAST t]
	:	variableDeclarator[(TokenKeepingAST)getASTFactory().dupTree(mods),
						   (TokenKeepingAST)getASTFactory().dupTree(t)]
		(	COMMA!
			variableDeclarator[(TokenKeepingAST)getASTFactory().dupTree(mods),
							   (TokenKeepingAST)getASTFactory().dupTree(t)]
		)*
 ...
 */
variableDeclarator![TokenKeepingAST mods, TokenKeepingAST t]
	:	id:IDENT d:declaratorBrackets[t] v:varInitializer
		{#variableDeclarator = #(#[VARIABLE_DEF,"VARIABLE_DEF"], mods, #(#[TYPE,"TYPE"],d), id, v);}
	;

declaratorBrackets[TokenKeepingAST typ]
